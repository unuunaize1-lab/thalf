...
const { normalizePhoneNumber, isValidIndianMobile } = require('../src/lib/phone-utils');
const { hashPassword, verifyPassword, generateSessionToken, hashSessionToken } = require('../src/lib/auth-crypto');
const { authService } = require('../src/services/auth.service');
const { inMemoryRateLimiter, authRateLimiter } = require('../src/lib/rate-limiter');
