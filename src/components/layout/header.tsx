      ...
      <header className="sticky top-0 z-40 w-full border-b border-parchment/60 bg-cream/95 backdrop-blur-md transition-all duration-300">
          ...
          <div className="flex h-20 items-center justify-between">
            ...
            <div className="flex flex-col items-center">
              <Link href="/" className="flex flex-col items-center group">
                <span className="font-editorial text-3xl md:text-4xl font-light uppercase tracking-[0.3em] text-dark group-hover:text-gold transition-colors duration-300">
                  THALF
                </span>
                <span className="text-[8px] font-bold uppercase tracking-[0.45em] text-gold mt-0.5 font-sans">
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden border-t border-parchment bg-cream/98 h-screen p-8 animate-fade-in flex flex-col justify-between">
            ...
            <div className="pb-24 text-center space-y-2 border-t border-parchment pt-6">
              <p className="text-[10px] uppercase tracking-ultra text-gold">THALF</p>
